...
import { getCompetitionById, updateCompetition, getAllEvents } from "../../../services/firebaseUtils";
...
function EditCompetition() {
  ...
  const fetchData = async () => {
    try {
      ...
      if (comp) {
        setEventId(comp.eventId || "");
        setTitle(comp.title || "");
        setDescription(comp.description || "");
        setVenue(comp.venue || "");
        setCapacity(comp.capacity || "");
        setPrize(comp.prize || "");
        setCompetitionDate(comp.competitionDate || "");
        setCompetitionTime(comp.competitionTime || "");
  ...
  const handleUpdate = async (e) => {
    ...
    if (!eventId || !title || !description || !venue || !capacity || !competitionDate || !competitionTime) {
    ...
    try {
      ...
      await updateCompetition(id, competitionData);
          ...
          <div className="row">
            <div className="col-12 text-center">
              ...
              <ol className="breadcrumb p-0 m-0">
                ...
                <li className="breadcrumb-item active">Edit Competition</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="section-title">
                <h3>
                  Update <span className="alternate">Competition</span>
                </h3>
                <p>Modify the competition details below.</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleUpdate} className="row">
            ...
            <div className="col-md-12 mt-4">
              <label style={{ color: "#FF6B35", fontWeight: "bold", marginBottom: "5px", display: "block" }}>Competition Title</label>
              <input
                type="text"
                className="form-control main"
            ...
            <div className="col-md-12">
              ...
              <input
                ...
                onChange={(e) => setCompetitionTime(e.target.value)}
              />
            </div>
