...
function AddMenu() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoad(true);
    try {
      await TableService.add({ tableNumber, capacity, ratePerHour, imageUrl, categoryId, categoryName });
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <h5 className="section-title ff-secondary text-start text-primary fw-normal mb-2">Add Table</h5>
              <h1 className="mb-4">New Table</h1>
              ...
              <form onSubmit={handleSubmit}>
                <div className="row g-3">
                  ...
                  <div className="col-12">
                    <button className="btn btn-primary w-100 py-3" type="submit" disabled={uploading}>Add Table</button>
                  </div>
                </div>
              </form>
            </div>
